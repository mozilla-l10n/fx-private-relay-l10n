...
faq-question-availability-answer-v4 = La versión gratuita de { -brand-name-relay } está disponible en la mayoría de los países. { -brand-name-relay-premium } está disponible en Alemania, Austria, Bélgica, Bulgaria, Canadá, Chipre, Croacia, Dinamarca, Eslovaquia, Eslovenia, España, Estados Unidos, Estonia, Finlandia, Francia, Grecia, Hungría, Irlanda, Italia, Letonia, Lituania, Luxemburgo, Malasia, Malta, Nueva Zelanda, Países Bajos, Polonia, Portugal, Reino Unido, República Checa, Rumanía, Singapur, Suecia y Suiza.
