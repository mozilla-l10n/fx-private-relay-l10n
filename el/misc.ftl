...
error-subdomain-not-available-2 = Ο υποτομέας @{ $unavailable_subdomain } δεν είναι διαθέσιμος. Δοκιμάστε έναν άλλο.
error-settings-update = Προέκυψε σφάλμα κατά την ενημέρωση των ρυθμίσεών σας, δοκιμάστε ξανά
error-mask-create-failed = Δεν ήταν δυνατή η δημιουργία της μάσκας. Δοκιμάστε ξανά.
# This currently appears when a mask label could not be updated,
# but in the future it might also appear if other mask data could not be changed.
error-mask-update-failed = Δεν ήταν δυνατή η ενημέρωση των δεδομένων της μάσκας. Δοκιμάστε ξανά.
# Variables:
...
trackerreport-load-error = Προέκυψε σφάλμα κατά τη δημιουργία της αναφοράς σας σχετικά με την αφαίρεση ιχνηλατών. Ανανεώστε τη σελίδα για να δοκιμάσετε ξανά.
...
#   $url (string) - URL of the support team website
#   $attrs (string) - In-line attributes for the link
first-time-user-email-footer-text-2-html = Για περισσότερες πληροφορίες, επισκεφτείτε την <a href="{ $url }" { $attrs }>Υποστήριξη { -brand-name-mozilla }</a>.
first-time-user-email-footer-text-2-text = Για περισσότερες πληροφορίες, επισκεφτείτε την Υποστήριξη { -brand-name-mozilla }.
...
first-time-user-email-welcome-subhead-2 = Αποκρύψτε το email σας. Ελέγξτε τα εισερχόμενά σας.
# Variables
#   $mask_limit (number) - the number of free email masks available
first-time-user-email-hero-primary-text-2 = Έχετε { $mask_limit } δωρεάν μάσκες email έτοιμες. Χρησιμοποιήστε μία όταν ψωνίζετε online ή εγγράφεστε για έναν νέο λογαριασμό ή εφαρμογή.
first-time-user-email-cta-dashboard-button-2 = Μετάβαση στο { -brand-name-firefox-relay }
...
first-time-user-email-hero-secondary-text-3 = Διαχειριστείτε όλες τις μάσκες σας από τον πίνακα ελέγχου του { -brand-name-relay }.
first-time-user-email-cta-dashboard-button-3 = Μάθετε να χρησιμοποιείτε τις μάσκες email
# Variables
...
first-time-user-email-how-item-1-subhead-text-2 = Απευθείας στο { -brand-name-firefox }, με το πρόσθετο { -brand-name-relay } ή από τον πίνακα ελέγχου σας.
first-time-user-email-how-item-2-header-2 = Προωθήστε τα email που θέλετε
first-time-user-email-how-item-2-subhead-2 = Οι αποστολείς δεν βλέπουν ποτέ την πραγματική σας διεύθυνση. Συνεχίστε να χρησιμοποιείτε μια μάσκα για να αποκρύψετε το πραγματικό σας email ή να αποκλείσετε τα email που λαμβάνετε.
first-time-user-email-how-item-3-header-2 = Εσείς έχετε τον έλεγχο
# Variables
#   $url (string) - link to sign in
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-2-html = <a href="{ $url }" { $attrs }>Συνδεθείτε</a> για να δημιουργήσετε, να προσθέσετε ετικέτες ή να διαγράψετε μάσκες οποιαδήποτε στιγμή.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-2-html = Επισκεφθείτε το <a href="{ $url }" { $attrs }>Κέντρο Υποστήριξης</a> για βοήθεια
first-time-user-email-questions-subhead-text-2 = Επισκεφτείτε το Κέντρο υποστήριξης για βοήθεια
first-time-user-email-footer-text-1-2 = Λαμβάνετε αυτό το αυτοματοποιημένο email ως συνδρομητής του { -brand-name-firefox-relay }. Εάν το λάβατε κατά λάθος, δεν απαιτείται καμία ενέργεια.
...
api-error-address-unavailable = Δεν ήταν δυνατή η δημιουργία του «{ $unavailable_address }». Δοκιμάστε ξανά με άλλο όνομα μάσκας.
api-error-need-subdomain = Επιλέξτε έναν υποτομέα πριν από τη δημιουργία μιας προσαρμοσμένης διεύθυνσης email.
api-error-account-is-paused = Ο λογαριασμός σας έχει τεθεί σε παύση.
# Variables:
#   $duplicate_address (string) - User-set email address that already exists
api-error-duplicate-address = Το «{ $duplicate_address }» υπάρχει ήδη. Δοκιμάστε ξανά με ένα άλλο όνομα μάσκας.
api-error-address-not-editable = Δεν μπορείτε να επεξεργαστείτε υπάρχον πεδίο διεύθυνσης τομέα.
api-error-account-is-inactive = Ο λογαριασμός σας δεν είναι ενεργός.
