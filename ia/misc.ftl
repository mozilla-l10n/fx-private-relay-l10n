...
first-time-user-email-how-item-1-subhead-2-html = Directemente in { -brand-name-firefox }, con le <a href="{ $url }" { $attrs }>additivo { -brand-name-relay }</a>, o ab tu pannello de controlo.
...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-2-html = <a href="{ $url }" { $attrs }>Accede</a> pro crear, etiquettar, o deler mascas quandocunque.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-2-html = Visita nostre <a href="{ $url }" { $attrs }>Centro de assistentia</a> pro adjuta
