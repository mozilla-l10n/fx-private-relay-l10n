...
whatsnew-feature-mailing-list-heading = Получите помощь в защите вашей конфиденциальности
# A preview of the full content of `whatsnew-feature-mailing-list-description`.
# Try to keep this string short, not longer than the English version.
whatsnew-feature-mailing-list-snippet = Нелегко быть в курсе последних советов по конфиденциальности и безопасности…
...
# Try to keep this string short, not longer than the English version.
whatsnew-holiday-promo-2023-news-snippet = В этот праздничный сезон получите скидку 20 % на 1 год подписки { -brand-name-relay-premium }.
whatsnew-holiday-promo-2023-news-heading = Получите скидку 20 % на { -brand-name-relay-premium }
