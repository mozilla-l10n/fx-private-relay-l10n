...
banner-download-install-extension-copy-2 = Η επέκταση του { -brand-name-relay } για το { -brand-name-firefox-browser(case: "nom", capitalization: "lowercase") } κάνει ακόμα ευκολότερη τη χρήση των μασκών email.
