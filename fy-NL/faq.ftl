...
faq-question-availability-answer-v4 = { -brand-name-relay } is fergees beskikber yn de measte lannen. { -brand-name-relay-premium } is beskikber yn Eastenryk, Bulgarije, België, Kanada, Kroaasje, Syprus, Tsjechië, Denemarken, Estlân, Finlân, Frankryk, Dútslân, Grikelân, Hongarije, Ierlân, Italië, Letlân, Litouwen, Lúksemboarch, Maleizje, Malta, Nederlân, Nij-Seelân, Poalen, Portugal, Roemenië, Singapoer, Slowakije, Slovenië, Spanje, Sweden, Switserlân, Feriene Keninkryk en de Feriene Steaten.
