...
nav-profile-manage-account = Gérer votre compte
...
nav-profile-image-alt-v2 = avatar du compte
...
nav-footer-stock-photo-legal = Les photographies de cette page proviennent de iStock, © iStockPhoto.com
