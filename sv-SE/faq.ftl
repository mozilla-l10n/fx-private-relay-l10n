...
faq-question-unsubscribe-domain-answer-3 = Om du nedgraderar från { -brand-name-relay-premium } kommer du fortfarande att få e-postmeddelanden vidarebefordrade via dina anpassade e-postalias, men du kommer inte längre att kunna skapa nya alias med den underdomänen. Om du har fler än { $mask_limit } alias totalt kommer du inte att kunna skapa fler. Du kommer också att förlora möjligheten att svara på vidarebefordrade meddelanden. Du kan prenumerera på { -brand-name-relay-premium } igen och få åtkomst till dessa funktioner igen.
...
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = Kräver betalning för att en användare ska skapa fler än { $mask_limit } alias
