...
modal-custom-alias-picker-tip-redesign = Совет. Чтобы создать собственный псевдоним без необходимости входа в { -brand-name-relay }, просто добавьте любое слово или фразу перед @ в своём почтовом домене { -brand-name-relay }. Когда кто-нибудь отправит это письмо в первый раз, ваш псевдоним будет создан автоматически.
