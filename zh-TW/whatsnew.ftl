...
whatsnew-feature-mask-expansion-heading = 50 組轉寄信箱，我們招待
whatsnew-feature-mask-expansion-snippet = 現在起，您會獲得 50 組免費轉寄信箱（原本是 5 組）。為每個帳號使用獨立的轉寄信箱，保護您實際電子郵件地址的隱私。
whatsnew-feature-mask-expansion-cta = 取得轉寄信箱
