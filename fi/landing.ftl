...
bundle-banner-body-3 = { -brand-name-mozilla-vpn } suojaa sinua seurannalta ja valvonnalta, kun pelaat, käytät verkkopankkia tai teet töitä. Lisää se { -brand-name-firefox-relay } -tilaukseen säästääksesi { $savings }.
...
waitlist-lead-bundle = Ilmoitamme, kun sinun on mahdollista saada { -brand-name-relay-premium } ja { -brand-name-mozilla-vpn } alennuksella alueellasi.
