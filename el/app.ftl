...
# Variables:
#   $end_date (string) - The localised date the introductory pricing offer ends, e.g. "September 27 2022"
landing-offer-end-hero-content = Αποκτήστε το { -brand-name-relay-premium } πριν τις { $end_date } και απολαύστε προνομιακή προστασία email στη μηνιαία τιμή γνωριμίας μας.
...
landing-how-it-works-step-3-body-2 =
    Συνδεθείτε στον πίνακα ελέγχου του { -brand-name-relay } για να παρακολουθήσετε τις μάσκες email σας.
    Αν δείτε ότι κάποια λαμβάνει ανεπιθύμητη αλληλογραφία, μπορείτε να αποκλείσετε όλα τα μηνύματα ή ακόμα και να διαγράψετε τη μάσκα, απευθείας από τον πίνακα ελέγχου.
...
landing-use-cases-heading = Χρησιμοποιήστε το { -brand-name-firefox-relay } για:
...
landing-use-cases-access-content-body-2 =
    ...
    Χρησιμοποιήστε μια μάσκα αντί της πραγματικής σας διεύθυνσης — αν αρχίσετε να λαμβάνετε ανεπιθύμητα email μέσω της μάσκας αυτής, ο αποστολέας ενδέχεται να την έχει πουλήσει σε άλλους διαφημιστές ή ίσως να έχει διαρρεύσει σε κάποια παραβίαση δεδομένων. 
    Απλώς απενεργοποιήστε ή διαγράψτε τη μάσκα για να προστατεύσετε τα εισερχόμενά σας.
...
onboarding-premium-domain-title-3 = Χρησιμοποιήστε έναν προσαρμοσμένο υποτομέα για κοινή χρήση μασκών:
...
multi-part-onboarding-premium-extension-get-description-2 = Η επέκταση του { -brand-name-relay } για το { -brand-name-firefox } κάνει ακόμα ευκολότερη τη χρήση μασκών email.
