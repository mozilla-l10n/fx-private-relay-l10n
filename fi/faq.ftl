...
faq-question-missing-emails-answer-reason-blocked-2 = Sähköpostipalveluntarjoajasi estää sähköpostimaskit
...
faq-question-availability-answer = Ilmainen { -brand-name-relay } on saatavilla useimmissa maissa. { -brand-name-relay-premium } on saatavilla Yhdysvalloissa, Saksassa, Isossa-Britanniassa, Kanadassa, Singaporessa, Malesiassa, Uudessa-Seelannissa, Ranskassa, Belgiassa, Itävallassa, Espanjassa, Italiassa, Sveitsissä, Alankomaissa ja Irlannissa.
faq-question-availability-answer-v2 = Ilmainen { -brand-name-relay } on saatavilla useimmissa maissa. { -brand-name-relay-premium } on saatavilla Yhdysvalloissa, Saksassa, Isossa-Britanniassa, Kanadassa, Singaporessa, Malesiassa, Uudessa-Seelannissa, Suomessa, Ranskassa, Belgiassa, Itävallassa, Espanjassa, Italiassa, Ruotsissa, Sveitsissä, Alankomaissa, ja Irlannissa.
...
faq-question-attachments-answer-v2 = Tuemme nyt liitteiden edelleenlähetystä. Sähköpostin edelleenlähetykselle { -brand-name-relay } asettaa kuitenkin kokorajoituksen { email-size-limit }. Sähköpostiviestejä, jotka ovat suurempia kuin { email-size-limit }, ei lähetetä edelleen.
...
faq-question-detect-promotional-answer = Monet sähköpostit lähetetään "otsake"-metatiedon kera sen osoittamiseksi, että ne ovat peräisin luettelopohjaisista automaattisista työkaluista. { -brand-name-firefox-relay } havaitsee nämä otsaketiedot, jotta se voi estää tällaiset sähköpostit.
