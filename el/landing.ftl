...
bundle-banner-body-3 = Το { -brand-name-mozilla-vpn } σάς προστατεύει από την καταγραφή και την παρακολούθηση ενώ παίζετε παιχνίδια, πραγματοποιείτε τραπεζικές συναλλαγές ή εργάζεστε. Προσθέστε το στο { -brand-name-firefox-relay } για εξοικονόμηση { $savings }.
...
plan-matrix-offer-body = Το { -brand-name-firefox-relay } προστατεύει την ταυτότητα και τα εισερχόμενά σας με μοναδικές μάσκες email. Προσθέστε ακόμα περισσότερη ασφάλεια με την απόκρυψη τηλεφώνου του { -brand-name-relay } και εξοικονομήστε { $savings } προσθέτοντας την προστασία του { -brand-name-vpn }.
...
highlighted-features-section-unlimited-masks-body-2 =
    ...
    Αλλά με το { -brand-name-relay-premium }, μπορείτε να δημιουργήσετε όσες μάσκες χρειάζεστε για την προστασία των email σας 
    από ανεπιθύμητα μηνύματα, χάκερ, παραβιάσεις δεδομένων και διαδικτυακούς ιχνηλάτες.
...
highlighted-features-section-title = Ασφαλείς, απλές λειτουργίες που βοηθούν στην προστασία της ταυτότητάς σας
