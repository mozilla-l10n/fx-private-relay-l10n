...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-2-html = <a href="{ $url }" { $attrs }>Sign in</a> to create, label or delete masks at any time.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-2-html = Visit our <a href="{ $url }" { $attrs }>Support Centre</a> for help
