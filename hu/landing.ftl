...
premium-promo-availability-warning-4 = A { -brand-name-relay-premium } Ausztriában, Bulgáriában, Belgiumban, Kanadában, Horvátországban, Cipruson, a Cseh Köztársaságban, Dániában, Észtországban, Finnországban, Franciaországban, Németországban, Görögországban, Magyarországon, Írországban, Olaszországban, Lettországban, Litvániában, Luxemburg, Malajzia, Málta, Hollandia, Új-Zéland, Lengyelország, Portugália, Románia, Szingapúr, Szlovákia, Szlovénia, Spanyolország, Svédország, Svájc, az Egyesült Királyság és az Egyesült Államok.
