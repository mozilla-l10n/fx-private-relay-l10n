...
faq-question-unsubscribe-domain-answer-3 = Si vous vous désabonnez de { -brand-name-relay-premium }, vous continuerez à recevoir les e-mails transférés via vos alias de messagerie personnalisés, mais vous ne pourrez plus créer de nouveaux alias à l’aide de ce sous-domaine. Si vous avez plus de { $mask_limit } alias au total, vous ne pourrez plus en créer. Vous perdrez également la possibilité de répondre aux messages transférés. Vous pouvez vous réabonner à { -brand-name-relay-premium } et accéder à nouveau à ces fonctionnalités.
...
faq-question-acceptable-use-answer-measure-account-v2 = exigeant la création d’un compte avec une adresse e-mail vérifiée
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = exigeant un paiement pour qu’un utilisateur ou une utilisatrice puisse créer plus de { $mask_limit } alias
