...
faq-question-unsubscribe-domain-answer-3 = 从 { -brand-name-relay-premium } 降级后您仍会收到转发到自定义马甲邮箱的电子邮件但无法再使用该子域名创建新马甲。若您的马甲总数超过 { $mask_limit } 个则将无法再创建。您也将无法回复转发的消息。您可以重新订阅 { -brand-name-relay-premium } 并重新获得这些功能。
