...
multi-part-onboarding-premium-welcome-feature-body-anonymous-replies = Yönlendirilen e-postaları gerçek e-posta adresinizi paylaşmadan yanıtlayın
...
multi-part-onboarding-premium-email-domain-placeholder = alanadiniz
multi-part-onboarding-premium-email-domain-added = E-posta alan adınız:
