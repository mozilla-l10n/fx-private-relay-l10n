...
landing-how-it-works-step-3-body-2 =
    ...
    Якщо ви виявите, що отримуєте спам або небажані повідомлення, ви можете заблокувати всі повідомлення або навіть видалити маску прямо з панелі керування.
...
faq-question-browser-support-answer-2 = Так, ви можете створювати маски { -brand-name-relay } в інших браузерах або на мобільних пристроях, просто увійшовши на свою панель керування { -brand-name-relay }.
...
onboarding-premium-domain-title-3 = Використовуйте власні піддомени, якими можна ділитися
...
multi-part-onboarding-premium-get-subdomain = Отримати індивідуальний піддомен
...
multi-part-onboarding-premium-get-domain-description-3b =
    За допомогою спеціального піддомену ви можете створювати маски, не генеруючи їх заздалегідь.
    Потрібна маска, щоб підписатися на інформаційний бюлетень? Просто вкажіть «read@вашдомен.{ $mozmail }»
multi-part-onboarding-premium-domain-cta-2 = Зареєструйте власний піддомен зараз:
multi-part-onboarding-premium-domain-button-skip-2 = Продовжити, я зареєструю свій піддомен згодом
