...
survey-csat-question = Qual é seu nível de satisfação com a experiência de uso do { -brand-name-firefox-relay }?
...
first-time-user-email-cta-dashboard-button = Aprenda a usar o { -brand-name-relay }

## Email sent to people onboarding that receive their first forwarded email.

our-promise-header = Nossa promessa para você
