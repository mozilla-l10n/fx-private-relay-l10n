...
# Try to keep this string short, not longer than the English version.
whatsnew-holiday-promo-2023-news-snippet = Αυτές τις γιορτές, λάβετε έκπτωση 20% στην τιμή του { -brand-name-relay-premium } για ένα έτος.
...
whatsnew-feature-mask-expansion-heading = 50 δωρεάν μάσκες email
whatsnew-feature-mask-expansion-snippet = Έχετε πλέον 50 δωρεάν μάσκες (αντί για 5). Χρησιμοποιήστε μία για κάθε λογαριασμό, ώστε να διατηρείτε το πραγματικό σας email απόρρητο.
whatsnew-feature-mask-expansion-cta = Απόκτηση μασκών email
