...
faq-question-unsubscribe-domain-answer-3 = Se regredir a versão do { -brand-name-relay-premium }, continuará a receber os e-mails reencaminhados através das suas máscaras de e-mail personalizadas, mas deixará de poder criar novas máscaras com esse subdomínio. Se tiver mais de { $mask_limit } máscaras no total, não poderá criar outras. Também deixará de poder responder às mensagens reencaminhadas. Pode voltar a subscrever o { -brand-name-relay-premium } e recuperar o acesso a estas funcionalidades.
...
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = Exigir um pagamento para que um utilizador possa criar mais de { $mask_limit } máscaras
...
faq-question-trackerremoval-breakage-question = Por que razão os meus e-mails parecem estar danificados?
faq-question-trackerremoval-breakage-answer-2 = Por vezes, a eliminação de rastreadores pode fazer com que os seus e-mails pareçam danificados, dado que os rastreadores se encontram frequentemente em imagens e ligações. Ao remover o rastreador, o e-mail parece estar mal formatado devido à falta de imagens. Este problema não pode ser resolvido nos e-mails que já foram recebidos. Se isto estiver a dificultar a leitura adequada dos seus e-mails, desative a remoção de rastreadores.
faq-question-define-tracker-question = O que são os rastreadores de e-mail?
faq-question-define-tracker-answer-partone = O rastreamento de e-mails é uma ferramenta comum de monitorização e publicidade que tem tomado muitas caixas de entrada. Estes rastreadores podem ser utilizados para compreender e saber mais sobre o seu comportamento na Internet, os seus interesses e a sua atividade no correio eletrónico.
faq-question-define-tracker-answer-parttwo = Uma empresa ou organização irá incorporar um rastreador nos e-mails enviados para si, geralmente oculto dentro de uma imagem ou ligação. Quando o e-mail é aberto, o código dentro do rastreador envia os dados novamente para a empresa.
