...
faq-question-availability-answer-v4 = La version gratuite de { -brand-name-relay } est disponible dans la plupart des pays. { -brand-name-relay-premium } est disponible en Allemagne, en Autriche, en Bulgarie, en Belgique, au Canada, en Croatie, à Chypre, au Danemark, en Estonie, en Finlande, en France, en Grèce, en Hongrie, en Irlande, en Italie, en Luxembourg, Malaisie, Malte, Espagne, États-Unis, Nouvelle-Zélande, Pologne, Portugal, Roumanie, Singapour, Slovaquie, Slovénie, Royaume-Uni, Suède et Suisse.
