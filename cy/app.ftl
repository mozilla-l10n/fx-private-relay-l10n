...
nav-duo-phone-mask-alt = Cuddio ffôn
...
#   $monthly_price (string) - the monthly cost (including currency symbol) for a given plan. Examples: $0.99, 0,99 €
# Please preserve the asterisk (*) following the price; it indicates that the price is billed yearly.
plan-matrix-bundle-offer-heading-2 = Am amser cyfyngedig yn unig: { -brand-name-relay-premium } + { -brand-name-mozilla-vpn } { $monthly_price }/month*
...
setting-api-key-copied-alt = Clicio i gopïo
...
setting-tracker-removal-warning-2 = Pwysig: Gall cael gwared ar dracwyr achosi i'ch e-bost edrych fel eu bod wedi torri oherwydd bod tracwyr yn aml wedi'u cynnwys mewn delweddau a dolenni. Nid oes modd trwsio nac adfer unrhyw e-byst a gewch fel hyn.
...
faq-question-landing-page-availability = Mae { -brand-name-relay } ar gael am ddim yn y mwyafrif o wledydd. Mae arallenwau e-bost { -brand-name-relay-premium } ar gael yn yr Unol Daleithiau, yr Almaen, y Deyrnas Unedig, Canada, Singapore, Malaysia, Seland Newydd, Ffrainc, Gwlad Belg, Awstria, Sbaen, yr Eidal, y Swistir, yr Iseldiroedd ac Iwerddon.  Mae cuddio rhif ffôn { -brand-name-relay-premium } ar gael yn yr UDA a Chanada, yn unig.
...
multi-part-onboarding-premium-reply-description = Atebwch e-byst heb ddatgelu eich cyfeiriad go iawn:
