...
faq-question-availability-answer-v4 = { -brand-name-relay } gratuite es disponibile in le major parte del paises. { -brand-name-relay-premium } es disponibile in Austria, Bulgaria, Belgio, Canada, Croatia, Cypro, Republica Chec, Danmark, Estonia, Finlandia, Francia, Germania, Grecia, Hungaria, Irlanda, Italia, Latvia, Lituania, Luxemburg, Malaysia, Malta, Hollanda, Nove Zelanda, Polonia, Portugal, Romania, Singapore, Slovachia, Slovenia, Espania, Svedia, Suissa, Regno Unite, e le Statos Unite.
...
faq-question-acceptable-use-answer-measure-account-v2 = Il es obligatori usar un conto con un adresse email verificate
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = Requirer le pagamento pro un usator pro crear plus que { $mask_limit } mascas
