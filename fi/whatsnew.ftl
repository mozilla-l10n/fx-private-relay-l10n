...
# Try to keep this string short, not longer than the English version.
whatsnew-feature-forward-some-snippet = { -brand-name-relay-premium } sallii sinun estää vain mainossähköpostit…
...
# Try to keep this string short, not longer than the English version.
whatsnew-feature-tracker-removal-snippet = Nyt { -brand-name-relay } voi poistaa yleiset sähköpostiviesteissä olevat seuraimet edelleenlähetetyistä sähköposteista…
