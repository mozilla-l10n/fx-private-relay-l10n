...
faq-question-availability-answer-v4 = مفت { -brand-name-relay } زیادہ تر ملکاں وِچ دستیاب ہے۔ { -brand-name-relay-premium } آسٹریا، بیلجیم، بلغاریہ، کینیڈا، کروشیا، قبرص،  چیک جمہوریہ، ڈنمارک، ایسٹونیا، فن لینڈ، فرانس، جرمنی، یونان، ہنگری،  آئرلینڈ، اٹلی، لٹویا، لتھوانیا، لکسمبرگ، ملائیشیا، مالٹا، نیدرلینڈز، نیوزی لینڈ، پولینڈ، پرتگال، رومانیہ، سنگاپور، سلوواکیہ، سلووینیا، اسپین، سویڈن، سوئٹزرلینڈ، برطانیہ، تے ریاستہائے متحدہ وِچ دستیاب ہے۔
