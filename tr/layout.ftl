...
nav-menu = Menü
nav-home = Ana sayfa
nav-email-dashboard = E-posta maskeleri
...
# This is only visible to Premium users.
nav-profile-contact-tooltip = { -brand-name-relay-premium } ile ilgili bize ulaşın
# Deprecated
...
menu-upgrade-button = Yükseltme
menu-toggle-open = Menüyü aç
menu-toggle-close = Menüyü kapat
nav-settings = Ayarlar
nav-support = Yardım ve destek
...
bento-button-title = { -brand-name-firefox } uygulamaları ve hizmetleri
