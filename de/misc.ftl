...
first-time-user-email-how-item-1-subhead-html-2 = Direkt in { -brand-name-firefox }, mit dem <a href="{ $url }" { $attrs }>{ -brand-name-relay }-Add-on</a> oder auf Ihrer { -brand-name-relay }-Übersicht.
...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-html-2 = <a href="{ $url }" { $attrs }>Melden Sie sich an</a>, um jederzeit Masken zu erstellen, zu beschriften oder zu löschen.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-html-2 = Besuchen Sie unser <a href="{ $url }" { $attrs }>Hilfe-Center</a>, um Unterstützung zu erhalten
