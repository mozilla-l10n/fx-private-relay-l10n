...
tips-custom-alias-content-2 = Све што треба да урадите јесте да смислите и поделите јединствена маску која користи ваш прилагођени поддомен - маска ће бити самостално направљена. На пример, следећи пут када будете куповали на мрежи, покушајте са „shop@customdomain.mozmail.com“.
...
trackerreport-breakage-warning-2 = Важно: уклањање пратилаца може проузроковати да ваша е-пошта изгледа неисправно, јер се пратиоци често налазе у сликама и везама. Било које е-поруке које примите на овај начин не могу се поправити или вратити.
trackerreport-faq-heading = Најчешћа питања о пратилацима у е-пошти
...
offer-countdown-timer-alt =
    { $remaining_days ->
       ...
       *[other]
            { $remaining_hours ->
                [1] { $remaining_days } дана и 1 сат преостало
...
relay-email-trackers-removed =
    { $number ->
        ...
        [few] { $number } елемента за праћење е-поште уклоњена
       *[other] { $number } елемената за праћење е-поште уклоњена
    }
...
first-time-user-email-welcome = Добродошли у { -brand-name-firefox-relay }
first-time-user-email-preheader = Маскирање е-поште за заштиту вашег идентитета
first-time-user-email-welcome-subhead = Ваша адреса е-поште може се користити за ваше праћење на мрежи - ту смо да помогнемо да се то прекине.
first-time-user-email-hero-primary-text = Као корисник { -brand-name-firefox }-а, добијате 5 маски за е-пошту бесплатно. Користите их да сакријете своју стварну адресу е-поште, заштитите свој идентитет и прослеђујете само е-поште које желите у свој примљени сандуче.
...
our-promise-content = Маске за е-пошту { -brand-name-relay } прослеђују у ваш примљени сандуче све поруке послате на ту маску за е-пошту - без откривања ваше стварне адресе е-поште пошиљаоцу.
...
what-can-you-do-with-relay-point-one-subpoint-html = Уместо тога, само поделите маску за е-пошту. Маске за е-пошту ће прослеђивати е-поште у ваш примљени сандуче. Маске можете креирати директно у { -brand-name-firefox }, помоћу <a { $attrs }>додатка { -brand-name-relay }</a>, или на својој командној табли { -brand-name-relay }.
what-can-you-do-with-relay-point-two = Спречите веб-сајтове и спамере да лако прате ко сте ви
what-can-you-do-with-relay-point-two-subpoint = Елементи за праћење е-поште су данас свуда. Маске за е-пошту { -brand-name-relay } вам помажу да их држите у незисици.
what-can-you-do-with-relay-point-three = Спречите спам да стигне у ваш примљени сандуче и чак потпуно искључите маске
what-can-you-do-with-relay-point-three-subpoint = На командној табли { -brand-name-relay }-а можете направити маске, означити их како бисте забележили где их користите, укључити блокирање спама и обрисати све оне које вам више нису потребне.
forwarded-email-hero-header = Добили сте своју прву прослеђену е-пошту!
forwarded-email-hero-desc = Видите ли оно заглавље? Појавиће се на свим е-поштама које проследују маске { -brand-name-relay }.
...
first-time-user-email-how-item-1-subhead-html = Направите маске директно у { -brand-name-firefox }, помоћу <a href="{ $url }" { $attrs }>додатка { -brand-name-relay }</a>, или на својој командној табли { -brand-name-relay }.
first-time-user-email-how-item-1-subhead-text = Направите маске директно у { -brand-name-firefox }, помоћу додатка { -brand-name-relay }, или на својој командној табли { -brand-name-relay }.
first-time-user-email-how-item-2-header = Проследићемо све е-поште у ваш примљени сандуче
first-time-user-email-how-item-2-subhead = Пошиљаоци никада неће видети вашу стварну адресу, а е-поште можете блокирати у било ком тренутку.
first-time-user-email-how-item-3-header = Управљајте својим маскама са своје командне табле { -brand-name-relay }
# Variables
#   $url (string) - URL of the dashboard
#   $attrs (string) - Inline attributes for the link
first-time-user-email-how-item-3-subhead-html = <a href="{ $url }" { $attrs }>Пријавите се</a> да бисте креирали нове маске, означили своје маске и обрисали маске које примају спам.
first-time-user-email-how-item-3-subhead-text = Пријавите се да бисте креирали нове маске, означили своје маске и обрисали маске које примају спам.
first-time-user-email-extra-protection-inbox-phone-title = Додатна заштита за ваш примљени сандуче и телефон
first-time-user-email-extra-protection-inbox-phone-subhead = Надоградите на { -brand-name-relay-premium } за неограничен број маски за е-пошту - плус маску за телефон за заштиту вашег стварног броја.
first-time-user-email-extra-protection-cta = Набавите { -brand-name-relay-premium }
first-time-user-email-questions-title = Имате питања о { -brand-name-firefox-relay }?
# Variables
...
first-time-user-email-footer-text-1 = Ову аутоматизовану е-пошту примате као претплатник { -brand-name-firefox-relay } који је први пут користио { -brand-name-relay }. Ако сте је примили погрешно, није потребно да предузимате никакве мере.
# Variables
#   $url (string) - URL of the support team website
#   $attrs (string) - In-line attributes for the link
...
first-time-user-email-footer-text-legal = Правне информације
first-time-user-email-footer-text-privacy = Услови и приватност

## Updated first-time user welcome email (MPP-4613)

first-time-user-email-welcome-subhead-2 = Маскирајте своју е-пошту. Контролишите свој примљени сандуче.
# Variables
#   $mask_limit (number) - the number of free email masks available
first-time-user-email-hero-primary-text-2 = Имате { $mask_limit } бесплатних маски за е-пошту спремних за употребу. Користите једну од њих када купујете на мрежи или се региструјете за нови налог или апликацију.
first-time-user-email-cta-dashboard-button-2 = Идите на { -brand-name-firefox-relay }
first-time-user-email-how-item-1-header-2 = Направите маску за неколико секунда
...
# Variables
#   $mask_limit (number) - the number of free email masks available
first-time-user-email-hero-primary-text-3 = Као корисник { -brand-name-firefox }-а, добијате { $mask_limit } маски за е-пошту бесплатно. Користите их да сакријете своју стварну адресу е-поште, заштитите свој идентитет и прослеђујете само е-поште које желите у свој примљени сандуче.
first-time-user-email-hero-secondary-text-3 = Управљајте свим својим маскама са своје командне табле { -brand-name-relay }.
...
first-time-user-email-how-item-1-subhead-2-html = Директно у { -brand-name-firefox }, помоћу <a href="{ $url }" { $attrs }>додатка { -brand-name-relay }</a>, или са ваше командне табле.
first-time-user-email-how-item-1-subhead-text-2 = Директно у { -brand-name-firefox }, помоћу додатка { -brand-name-relay }, или са ваше командне табле.
first-time-user-email-how-item-2-header-2 = Прослеђујте е-поште које желите
first-time-user-email-how-item-2-subhead-2 = Пошиљаоци никада не виде вашу стварну адресу. Наставите да користите маску како бисте сакрили своју стварну е-пошту или блокирајте е-поште које примате.
first-time-user-email-how-item-3-header-2 = Ви имате контролу
# Variables
#   $url (string) - link to sign in
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-2-html = <a href="{ $url }" { $attrs }>Пријавите се</a> да бисте креирали, означили или обрисали маске у било ком тренутку.
first-time-user-email-how-item-3-subhead-text-2 = Пријавите се да бисте креирали, означили или обрисали маске у било ком тренутку.
# Variables
...
api-error-free-tier-limit = Искористили сте свих { $free_tier_limit } маски за е-пошту које су укључене у ваш бесплатни налог. Можете поново употребити постојећу маску, али коришћење јединствене маске за сваки налог је најсигурнија опција.
api-error-free-tier-no-subdomain-masks = Ваш бесплатни налог не укључује прилагођене поддомене за маске. Да бисте креирали прилагођене маске, надоградите на { -brand-name-relay-premium }.
# Variables:
#   $unavailable_address (string) - User-set subdomain that is not allowed
api-error-address-unavailable = „{ $unavailable_address }“ није могла бити креирана. Покушајте поново са другим називом маске.
api-error-need-subdomain = Изаберите поддомен пре креирања прилагођене адресе е-поште
