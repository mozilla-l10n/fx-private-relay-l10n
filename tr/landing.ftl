...
hero-section-social-proof = Övgüyle bahsedenler
...
bundle-feature-one = { $num_vpn_servers }+ sunucu
# Variables:
...
plan-matrix-heading-features = Özellikler
...
plan-matrix-heading-price = Fiyat
plan-matrix-feature-count-unlimited = Sınırsız
plan-matrix-feature-included = Dahil
plan-matrix-feature-not-included = Dahil değil
plan-matrix-price-free = Ücretsiz
...
landing-reviews-details-source = Kaynak: addons.mozilla.org
# This string is displayed in a smaller font under a big number representing the average review score (e.g. "4.2").
# Review count will stand for the total number of reviews at a given time (e.g. "328 reviews").
landing-reviews-rating = / 5 ({ $review_count } inceleme)
...
highlighted-features-section-new-item = Yeni!
...
waitlist-control-required = Gerekli
waitlist-control-email-label = E-posta adresiniz nedir?
