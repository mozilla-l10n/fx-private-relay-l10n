...
first-time-user-email-how-item-1-subhead-html-2 = Прямо в { -brand-name-firefox } с помощью <a href="{ $url }" { $attrs }>дополнения { -brand-name-relay }</a> или из панели управления.
...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-html-2 = <a href="{ $url }" { $attrs }>Войдите</a>, чтобы создавать, помечать или удалять псевдонимы в любое время.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-html-2 = Посетите наш <a href="{ $url }" { $attrs }>Центр поддержки</a>, чтобы получить помощь
