...
faq-question-availability-answer-v4 = { -brand-name-relay } 免費版在大多數國家皆能使用。{ -brand-name-relay-premium } 已在奧地利、保加利亞、比利時、加拿大、克羅埃西亞、賽普勒斯、捷克、丹麥、愛沙尼亞、芬蘭、法國、德國、希臘、匈牙利、愛爾蘭、義大利、拉脫維亞、立陶宛、盧森堡、馬來西亞、馬爾他、荷蘭、紐西蘭、波蘭、葡萄牙、羅馬尼亞、新加坡、斯洛伐克、斯洛維尼亞、西班牙、瑞典、瑞士、英國、美國等地推出。
...
faq-question-unsubscribe-domain-answer-3 = 若您從 { -brand-name-relay-premium } 降級回免費版，還是會收到透過自訂轉寄信箱轉寄的郵件，但無法再使用該子網域來建立新轉寄信箱。若您已有超過 { $mask_limit } 組轉寄信箱，將無法再建立新的轉寄信箱。您也將無法再直接回覆收到的轉寄郵件。再次訂閱 { -brand-name-relay-premium } 即可重新獲得這些功能。
...
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = 要求使用者付款才可以建立超過 { $mask_limit } 組轉寄信箱
...
faq-question-promotional-email-blocking-answer = { -brand-name-relay-premium } 訂閱者可開啟行銷郵件封鎖功能。此功能將會把消費收據、密碼重設信、確認信件等重要信件轉寄給您，但會封鎖所有行銷郵件。我們還是有些微的可能誤擋到重要郵件，所以建議您不要在重要的服務（例如銀行）使用此功能。若郵件遭到封鎖，將無法救回。
