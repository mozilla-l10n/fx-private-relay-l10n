...
bundle-banner-body-3 = Mae { -brand-name-mozilla-vpn } yn eich diogelu rhag tracio a gwyliadwriaeth tra byddwch yn chwarae gemau, yn bancio ar-lein, neu'n gwneud eich gwaith. Ychwanegwch ef at { -brand-name-firefox-relay } am { $savings } yn llai.
...
highlighted-features-section-unlimited-masks-body-2 =
    ...
    Ond gyda { -brand-name-relay-premium }, gallwch gynhyrchu cymaint o arallenwau ag sydd eu hangen arnoch i helpu i ddiogelu eich blwch
    derbyn e-bost rhag  sbamwyr, hacwyr, a thracwyr ar-lein.
