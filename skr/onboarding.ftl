...
multi-part-onboarding-premium-email-domain-feature-body = آپݨاں مَن بھان٘دہ { -brand-name-relay } ای میل ڈومین چُݨو، وَل @ علامت کنوں پہلاں کُئی وی لوّظ یا جملہ شامل کر کے فوری طور تے نویں ماسک بݨاؤ۔ <p>خریدار؟ shop@yourdomainاستعمال کرو۔{ $mozmail }</p>
...
multi-part-onboarding-premium-add-extension-feature-body = { -brand-name-relay }ایکسٹنشن تُہاکوں فوری طور تے نویں ماسک بݨاوݨ ݙٰن٘دی ہِے جہڑیلے وی ویب سائٹ تُہاݙے ای میل پتے دے بارے وِچ پُچھدی ہِے — صرف { -brand-name-relay } آئیکن کوں لبّھو۔
