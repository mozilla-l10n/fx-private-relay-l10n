...
error-general = Něco se pokazilo. Zkuste to prosím znovu později.
...
first-time-user-email-welcome-subhead-3 = Vaše e-mailová adresa může být zneužita k vašemu sledování na internetu — jsme tu, abychom vám pomohli tomu zabránit.
# Variables
#   $mask_limit (number) - the number of free email masks available
first-time-user-email-hero-primary-text-3 = Jako uživatel aplikace { -brand-name-firefox } získáte zdarma { $mask_limit } e-mailových masek. Využijte je k zakrytí své skutečné e-mailové adresy, ochraně své identity a přesměrování pouze těch e-mailů, které chcete, do své doručené pošty.
first-time-user-email-hero-secondary-text-3 = Spravujte všechny své masky z ovládacího panelu { -brand-name-relay }.
