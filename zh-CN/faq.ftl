...
faq-question-unsubscribe-domain-answer-3 = 若不再续订 { -brand-name-relay-premium }，您仍能收到之前自定义马甲邮箱转发的电子邮件，但无法再使用该子域名新建马甲。若已有 { $mask_limit } 个以上马甲，则无法创建更多马甲。您也将无法回复转发的消息。重新订阅 { -brand-name-relay-premium } 才可重获这些功能的使用权。
...
faq-question-acceptable-use-answer-measure-account-v2 = 需要通过已验证的邮箱地址来申请账户
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = 要求用户付费才能创建超过 { $mask_limit } 个马甲
