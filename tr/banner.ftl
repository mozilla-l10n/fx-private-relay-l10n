...
tooltip-email-domain-explanation-part-one-free = { -brand-name-premium } ile kendinize ait { -brand-name-relay } e-posta alan adıyla her an her yerde sınırsız { -brand-name-relay } maskesi oluşturabilirsiniz. Artık maskeleri buradan manuel olarak oluşturmanıza gerek kalmaz.
# Variables:
#   $mozmail (string): domain used by Relay masks (mozmail.com)
# "yourdomain" is used as an example custom domain. Keep it lowercase without space and in latin characters, to resemble and actual email address. Example: shopping@johndoe.mozmail.com
...
upsell-banner-4-masks-non-us-description = { -brand-name-relay-premium } size sınırsız e-posta maskesi, spam engelleme, kendinize ait { -brand-name-relay } e-posta alan adı ve iletilen iletileri yanıtlama olanağı sunar.
