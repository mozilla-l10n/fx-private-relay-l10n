...
whatsnew-feature-offer-countdown-heading = Us yntroduksjepriisoanbieding einiget ynkoarten!
# A preview of the full content of `whatsnew-feature-offer-countdown-description`.
# Try to keep this string short, not longer than the English version.
# Variables:
#   $end_date (string) - The localised date the introductory pricing offer ends, e.g. "September 27 2022"
whatsnew-feature-offer-countdown-snippet = Abonnearje jo foar { $end_date } op { -brand-name-relay-premium } en genietsje fan ûnbeheind maskearjen tsjin ús…
# Variables:
#   $end_date (string) - The localised date the introductory pricing offer ends, e.g. "September 27 2022"
whatsnew-feature-offer-countdown-description = Abonnearje jo foar { $end_date } op { -brand-name-relay-premium } en genietsje fan ûnbeheind maskearjen tsjin ús yntroduksjepriis foar in moanne-abonnemint.
whatsnew-feature-offer-countdown-cta = No opwurdearje
whatsnew-feature-firefox-integration-heading = { -brand-name-relay } is no beskikber yn de { -brand-name-firefox }-wachtwurdenbehearder
# A preview of the full content of `whatsnew-feature-firefox-integration-description`.
# Try to keep this string short, not longer than the English version.
whatsnew-feature-firefox-integration-snippet = It beskermjen fan jo e-mail is sakrekt makliker wurden. Jo kinne no…
whatsnew-feature-firefox-integration-description = It beskermjen fan jo e-mail is sakrekt makliker wurden. Jo kinne no nije { -brand-name-relay }-e-mailmaskers streekrjocht fan jo { -brand-name-firefox }-wachtwurdenbehearder út op desktop oanmeitsje.
...
# Variables:
#   $end_date (string) - The localised date the introductory pricing offer ends, e.g. "September 27 2022"
landing-offer-end-hero-content = Abonnearje jo foar { $end_date } op { -brand-name-relay-premium } en genietsje fan earsteklas e-mailbeskerming tsjin ús yntroduksjepriis foar in moanne-abonnemint.
...
# Variables:
#   $monthly_price (string) - the monthly cost (including currency symbol) for Relay Premium. Examples: $0.99, 0,99 €
landing-pricing-offer-end-headline = Yntroduksjepriis: ûnbeheinde aliassen foar { $monthly_price } yn ’e moanne
# Deprecated
landing-pricing-offer-end-warning = Dizze aksje ferrint ynkoarten
# Deprecated
landing-pricing-offer-end-cta = No opwurdearje
# Deprecated
# Variables:
#   $end_date (string) - The localised date the introductory pricing offer ends, e.g. "September 27 2022"
...
plan-matrix-bundle-offer-content =
    Probearje { -brand-name-firefox-relay }-e-mailmaskers en begjin mei it beskermjen fan jo Postfek YN.
    Wurdearje dêrnei op nei { -brand-name-relay-premium } foar noch mear fleksibiliteit en oanpasberheid.
plan-matrix-heading-plan-bundle = VPN-beskerming tafoegje
# This heading accompanies the number of email masks available in each plan (i.e. 5 for free plans, unlimited otherwise)
plan-matrix-heading-feature-email-masks = E-mailmaskers
plan-matrix-heading-feature-browser-extension = Browserútwreiding
plan-matrix-heading-feature-email-tracker-removal = E-mailtrackers fuortsmite
plan-matrix-heading-feature-promo-email-blocking = Reklameberjochten blokkearje
...
setting-api-key-copied-alt = Klikje om te kopiearjen
...
faq-question-landing-page-availability = Fergees { -brand-name-relay } is yn de measte lannen beskikber. { -brand-name-relay-premium }-e-mailmaskearing is beskikber yn de Ferienige Steaten, Dútslân, it Ferienige Keninkryk, Kanada, Singapore, Maleisië, Nij-Seelân, Frankryk, België, Eastenryk, Spanje, Italië, Switserlân, Nederlân en Ierlân. { -brand-name-relay-premium }-telefoanmaskearing is allinnich beskikber yn de F.S. en Kanada.
...
faq-question-disable-trackerremoval-question = Kin ik stopje mei it ferwiderjen fan e-mailtrackers?
faq-question-disable-trackerremoval-answer = Ja. As jo problemen hawwe mei e-mailberjochten dy’t der net goed útsjogge, of as jo stopje wolle mei it ferwiderjen fan trackers, kinne jo de funksje yn ynstellingen útskeakelje.
