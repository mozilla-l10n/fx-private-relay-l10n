...
highlighted-features-section-masks-on-the-go-body-2 =
    { -brand-name-relay-premium } vám poskytuje jedinečnú e‑mailovú doménu služby { -brand-name-relay }, takže si môžete okamžite vytvárať nové masky, nech ste kdekoľvek. Jednoducho pridajte akékoľvek slovo alebo frázu pred symbol @. Ste v reštaurácii? Použite restauracia@vasadomena.{ $mozmail }.
    Nakupujete? Skúste obchod@vasadomena.{ $mozmail }.

# Item 3

highlighted-features-section-replying-headline = Odpovedajte na e‑maily a SMSky anonymne
highlighted-features-section-replying-body-2 = { -brand-name-relay-premium } vám umožňuje odpovedať na e‑maily z vášho maskovaného e‑mailového účtu, takže odosielatelia nikdy nepoznajú vašu skutočnú e‑mailovú adresu. Pomocou maskovania telefónu môžete odpovedať na SMSky zo svojho maskovaného telefónneho čísla, aby ste ochránili svoje skutočné číslo.
...
highlighted-features-section-remove-trackers-body-2 = { -brand-name-relay } môže odstrániť bežné sledovacie prvky e‑mailov zo všetkých e‑mailov, ktoré vám preposielame, čím vám pomôže zostať neviditeľnými pre sledovačov a inzerentov.
