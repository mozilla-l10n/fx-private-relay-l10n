...
multi-part-onboarding-premium-get-domain-description =
    Usar un dominio personalizado para compartir alias: Con un dominio personalizado, puedes crear 
    alias sin tener que generarlas de antemano. ¿Necesitas registrarte a un boletín? Solo di “read@customdomain{ $mozmail }”
