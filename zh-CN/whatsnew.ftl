...
# Try to keep this string short, not longer than the English version.
whatsnew-feature-tracker-removal-snippet = 现在 { -brand-name-relay } 可以从转发的电子邮件中移除常见的跟踪器…
...
whatsnew-feature-mailing-list-heading = 获得保护隐私的相关帮助
...
# Try to keep this string short, not longer than the English version.
whatsnew-holiday-promo-2023-news-snippet = 假日季大促，{ -brand-name-relay-premium } 1 年期订阅享八折优惠。
...
whatsnew-holiday-promo-2023-news-content-description = 假日季大促，{ -brand-name-relay-premium } 1 年期订阅享八折优惠。结账时输入优惠码“HOLIDAY20”立享折扣。优惠期至 2023 年 12 月 31 日。
whatsnew-holiday-promo-2023-cta = 订阅 1 年期 { -brand-name-relay-premium }
whatsnew-feature-mask-expansion-heading = 50 个马甲邮箱由我们提供
whatsnew-feature-mask-expansion-snippet = 现在您可获得 50 个免费马甲从 5 个上调。多用一台账户可保护您的真实邮箱地址。
whatsnew-feature-mask-expansion-cta = 获取马甲邮箱
