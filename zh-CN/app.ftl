...
setting-label-collection-off-warning-3 = { -brand-name-firefox-relay } 将存储您使用过马甲邮箱的网站，并以这些网站标记您的马甲，方便您分辨。关闭此功能后，您将无法看到马甲在何处使用过，并且您的账户名称也将不再在设备之间同步。
...
faq-question-longevity-question = Mozilla 如果关闭 { -brand-name-firefox-relay } 服务我该怎么办？
...
faq-question-mozmail-answer-2 = 之所以从“relay.firefox.com”切换到“mozmail.com”，是为了自定义邮箱子域名这一特性，如 mask@<你的域名>.mozmail.com。{ -brand-name-relay-premium } 订阅者可使用自定义子域名生成更好记的马甲。
