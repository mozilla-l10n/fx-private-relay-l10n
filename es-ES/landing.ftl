...
hero-section-body =
    Nuestras máscaras de teléfono y correo electrónico seguras y fáciles de usar ayudan a mantener privada tu identidad
...
bundle-banner-body-3 = { -brand-name-mozilla-vpn } te protege del rastreo y vigilancia mientras juegas, realizas operaciones bancarias o trabajas en línea. Añádelo a { -brand-name-firefox-relay } para obtener { $savings } de descuento.
...
highlighted-features-section-unlimited-masks-body-2 =
    ...
    Pero con { -brand-name-relay-premium }, puedes generar tantas máscaras como necesites para ayudar a proteger tu correo electrónica
    de spammers, piratas informáticos, filtraciones de datos y rastreadores en línea.
