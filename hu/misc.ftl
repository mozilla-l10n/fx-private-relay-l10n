...
first-time-user-email-welcome-subhead-2 = Maszkolja az e-mail-címét. Irányítsa a postaládáját.
# Variables
...
first-time-user-email-how-item-1-subhead-2-html = Közvetlenül a { -brand-name-firefox }ban, a <a href="{ $url }" { $attrs }>{ -brand-name-relay } kiegészítővel</a>, vagy a vezérlőpultjáról.
...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-2-html = <a href="{ $url }" { $attrs }>Jelentkezzen be</a>, hogy bármikor létrehozza, címkézze vagy törölje a maszkokat.
...
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-2-html = Segítségért keresse fel a <a href="{ $url }" { $attrs }>Támogatási központunkat</a>
