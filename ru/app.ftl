...
faq-question-landing-page-availability = Бесплатный { -brand-name-relay } доступен в большинстве стран. Псевдонимы электронной почты { -brand-name-relay-premium } доступны в США, Германии, Великобритании, Канаде, Сингапуре, Малайзии, Новой Зеландии, Франции, Бельгии, Австрии, Испании, Италии, Швейцарии, Нидерландах и Ирландии. Маскирование телефона { -brand-name-relay-premium } доступно только в США и Канаде.
