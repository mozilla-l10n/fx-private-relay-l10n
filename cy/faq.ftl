...
faq-question-availability-answer-v4 = Mae { -brand-name-relay } am ddim ar gael yn y rhan fwyaf o wledydd. Mae { -brand-name-relay-premium } ar gael yn Awstria, Gwlad Belg, Canada, Cyprus, Estonia, y Ffindir, Ffrainc, yr Almaen, Gwlad Groeg, Iwerddon, yr Eidal, Latfia, Lithuania, Lwcsembwrg, Malaysia, Malta, yr Iseldiroedd, Seland Newydd, Portiwgal, Singapôr, Slofacia, Slofenia, Sbaen, Sweden, y Swistir, y Deyrnas Unedig, a'r Unol Daleithiau.
...
faq-question-subdomain-characters-question = Pa nodau ydw i'n gallu eu defnyddio i greu is-barth?
...
faq-question-browser-support-question = Ydw i'n gallu defnyddio { -brand-name-relay } ar borwyr eraill neu fy nyfais symudol?
...
faq-question-unsubscribe-domain-answer-3 = Os ydych chi'n israddio o { -brand-name-relay-premium }, byddwch chi'n dal i dderbyn e-byst sy'n cael eu hanfon ymlaen trwy'ch e-bost arallenw cyfaddas, ond fyddwch ddim yn gallu creu arallenwau newydd gan ddefnyddio'r is-barth hwnnw bellach. Os oes gennych fwy na { $mask_limit } arallenw, fydd dim modd i chi greu rhagor. Byddwch hefyd yn colli'r gallu i ateb i negeseuon fydd yn cael eu hanfon ymlaen. Gallwch ail-danysgrifio i { -brand-name-relay-premium } ac adennill mynediad i'r nodweddion hyn.
...
faq-question-acceptable-use-answer-measure-account-v2 = Angen cyfrif gyda chyfeiriad e-bost wedi'i ddilysu
faq-question-acceptable-use-answer-measure-unlimited-payment-3 = Mae angen taliad er mwyn i ddefnyddiwr greu mwy na { $mask_limit } arallenw
...
faq-question-disable-trackerremoval-question = Ydw i'n gallu rhoi'r gorau i ddileu tracwyr e-bost?
...
faq-question-bulk-trackerremoval-question = Ydw i'n gallu tynnu tracwyr o ddim ond rhai o fy arallenwau e-bost?
...
faq-question-trackerremoval-breakage-answer-2 = Weithiau gall cael gwared ar dracwyr achosi i'ch e-bost edrych fel eu bod wedi torri, oherwydd mae'r tracwyr yn aml wedi'u cynnwys o fewn delweddau a dolenni. Pan fydd y traciwr yn cael ei dynnu, mae'r e-bost yn edrych fel ei fod wedi'i fformatio'n anghywir oherwydd bod delweddau ar goll. Nid oes modd trwsio hyn ar gyfer e-byst rydych chi wedi'u derbyn yn barod. Os yw hyn yn eich atal rhag darllen eich e-byst yn iawn, diffoddwch dynnu traciwr.
