...
modal-custom-alias-picker-tip = İpucu: Özel maskelerinizi istediğiniz zaman kafanızdan uydurarak oluşturabilirsiniz. { -brand-name-relay } alan adınızı kullandığınızda, bu maskeleri önceden manuel olarak oluşturmasanız bile çalışırlar.
