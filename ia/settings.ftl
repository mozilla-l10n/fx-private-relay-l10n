...
setting-tracker-removal-description = Remover traciatores de e-mail in tote le messages reexpedite.
setting-tracker-removal-note = Ora { -brand-name-firefox-relay } pote ora remover traciatores commun de messages de e-mail reexpedite a transverso tu mascas.
