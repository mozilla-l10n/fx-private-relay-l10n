...
hero-section-social-proof = Как видно из
...
plan-matrix-offer-body = { -brand-name-firefox-relay } защищает вашу личность и ваш почтовый ящик с помощью уникальных псевдонимов электронной почты. Добавьте ещё больше безопасности с маскировкой телефона { -brand-name-relay } и сэкономьте { $savings }, добавив защиту { -brand-name-vpn }.
...
highlighted-features-section-masks-on-the-go-body-2 =
    ...
    создавать новые псевдонимы, где бы вы ни находились. Просто добавьте любое слово или фразу перед символом @. В ресторане? Используйте ресторан@вашдомен.{ $mozmail }. 
    Покупки? Попробуйте магазин@вашдомен.{ $mozmail }.
...
highlighted-features-section-replying-body-2 =
    { -brand-name-relay-premium } позволяет вам отвечать на электронные письма с вашей замаскированной учётной записи электронной почты, поэтому отправители никогда не узнают ваш настоящий адрес электронной почты. С маскированием телефона вы можете ответить
...
highlighted-features-section-block-promotions-body-2 = С { -brand-name-relay-premium } вы можете блокировать рекламные письма, при этом получая такие электронные письма, как квитанции и информацию о доставке.

# Item 5

highlighted-features-section-remove-trackers-headline = Удаление трекеров из электронных писем
highlighted-features-section-remove-trackers-body-2 = { -brand-name-relay } может удалять распространённые трекеры из всех пересылаемых электронных писем, помогая вам оставаться невидимыми для трекеров и рекламодателей.
