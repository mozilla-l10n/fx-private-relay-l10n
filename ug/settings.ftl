...
settings-headline = { -brand-name-relay } تەڭشەكلىرى
settings-meta-contact-label = بىز بىلەن ئالاقىلىشىڭ
...
setting-label-api-key = API ئاچقۇچى
# This is a label that appears on hover to copy the API key
settings-button-copy = چېكىلسە كۆچۈرىدۇ
setting-api-key-copied = كۆچۈرۈلدى!
setting-api-key-copied-alt = چېكىلسە كۆچۈرىدۇ
