...
landing-how-it-works-step-3-body-2 =
    Sign in to the { -brand-name-relay } dashboard to keep track of the email masks you’ve created.
...
landing-use-cases-shopping-body-2 =
    Buying something from a new online shop? Use an email mask instead of your true email when making an online purchase.
...
settings-warning-collection-off-description-3 = { -brand-name-relay } is not currently allowed to label your email masks with the web sites where you’ve used them. To change this, enable account names for email masks under “Privacy.”
...
setting-label-collection-off-warning-3 = { -brand-name-firefox-relay } will store the web sites where you’ve used your email masks, and label your masks with those web sites so you can easily identify them. Turning this off means you won’t be able to see where you’ve used each mask, and your account names will no longer synchronise between devices.
...
multi-part-onboarding-premium-add-extension-feature-headline-create-any-site = Create new { -brand-name-relay } masks from any web site
multi-part-onboarding-premium-add-extension-feature-body = The { -brand-name-relay } extension lets you instantly create new masks whenever web sites ask for your email address — just look for the { -brand-name-relay } icon.
