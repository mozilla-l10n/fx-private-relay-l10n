...
contains-tracker-description =
    Email trackers are surveillance tools that companies embed in emails to track your
...
what-can-you-do-with-relay-point-two = Keep web sites and spammers from easily tracking who you are
...
#   $attrs (string) - link attributes
first-time-user-email-how-item-3-subhead-html-2 = <a href="{ $url }" { $attrs }>Sign in</a> to create, label or delete masks at any time.
first-time-user-email-how-item-3-subhead-text-2 = Sign in to create, label or delete masks at any time.
# Variables
#   $url (string) - link to support center
#   $attrs (string) - link attributes
first-time-user-email-questions-subhead-html-2 = Visit our <a href="{ $url }" { $attrs }>Support Centre</a> for help
first-time-user-email-questions-subhead-text-2 = Visit our Support Centre for help
