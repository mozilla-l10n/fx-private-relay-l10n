...
plan-grid-card-free-item-two = <b>Extension de navigateur</b> pour utiliser { -brand-name-relay } sur n’importe quel site
plan-grid-card-free-item-three = <b>Supprimer les traqueurs des e-mails</b>
...
plan-grid-card-premium-item-one = <b>Alias de messagerie illimité</b> pour protéger votre véritable adresse e-mail
plan-grid-card-premium-item-two = <b>Bloquer les e-mails promotionnels</b>
...
plan-grid-card-phone-plus = Tout dans { -brand-name-relay-premium }
...
plan-grid-megabundle-vpn-description = Protection contre les activités en ligne
plan-grid-megabundle-monitor-title = { -brand-name-monitor-plus }
plan-grid-megabundle-monitor-description = Protection des courtiers de données
