...
plan-matrix-your-plan = Votre forfait
...
highlighted-features-section-replying-body-2 = { -brand-name-relay-premium } vous permet de répondre aux e-mails de votre alias de messagerie, afin que les expéditeurs ne connaissent jamais votre véritable adresse e-mail. Avec les alias de numéro de téléphone, vous pouvez répondre aux SMS de votre alias de numéro de téléphone pour protéger votre véritable numéro.

# Item 4

highlighted-features-section-block-promotions-headline = Blocage des e-mails promotionnels
highlighted-features-section-block-promotions-body-2 = Grâce à { -brand-name-relay-premium }, vous pouvez empêcher les e-mails promotionnels d’arriver dans votre boîte de réception tout recevant des messages tels que les reçus ou les avis d’expédition.

# Item 5

highlighted-features-section-remove-trackers-headline = Supprimer les traqueurs des e-mails
highlighted-features-section-remove-trackers-body-2 = { -brand-name-relay } peut supprimer les traqueurs courants des e-mails transférés sur votre adresse, vous aidant à rester invisible aux yeux des traqueurs et annonceurs.
