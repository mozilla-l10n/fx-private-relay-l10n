...
highlighted-features-section-unlimited-masks-body-2 =
    Quicunque ha { $mask_limit } mascas email gratuite. Ma con
    { -brand-name-relay-premium }, tu pote generar quante mascas te besonia
    pro adjutar te a proteger tu e-mail de spammatores, piratas informatic,
    violationes de datos, e traciatores online.
